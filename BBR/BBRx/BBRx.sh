...
case "$ID:${VERSION_ID%%.*}" in
    debian:12)
        bbrx_source_url="https://raw.githubusercontent.com/SAGIRIxr/Seedbox-Components/main/BBR/BBRx/tcp_bbrx.c"
        ;;
    debian:13)
        bbrx_source_url="https://raw.githubusercontent.com/SAGIRIxr/Seedbox-Components/main/BBR/BBRx/tcp_bbrx_debian13.c"
        ;;
    *)
...
# comes back up on that newer kernel with no tcp_bbrx.ko present, the
